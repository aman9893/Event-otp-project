...
<br/>
 <input type="button"  value=' CREATE AND PREVIEW ' onclick="bday_val();"/>
                   ...
                   <div class="team-item col-lg-4 col-md-8">
                   <div class="item-image">
                    <a href="function event/index.html"><img src="assets/images/traditional-birthday-celebration-its-signs-and-features.jpg" alt="" title="" media-simple="true"></a>
                    </div>
                   <div class="item-caption py-3">
                    <div class="item-name px-2">
                    <p >
                    
                     <a href="function event/index.html">&emsp; Bday Theme 2</a>
                     <br>
                    </div>
                    <br>
