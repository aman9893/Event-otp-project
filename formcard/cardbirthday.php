...
<h2> Invition Card </h2>
   ...
   <tr>
      <td class="wedwidths"><label class="control-label">Invition Date</label></td>
        <td class="wedwidths1">  <input type="date" class="form-control" name="WeddingDate" id="WeddingDate" placeholder="Date"/  > </td>
...
<tr>  
  ...
  <tr>
    ...
    <input type='text' id='mobile_otp' name='mobile_otp' value=''>
        ...
        $.ajax({
         ...
         // data:{'Phonetwo':Phonetwo},
           ...
           success: function(data) {
               ...
               {
                 window.open('../previewpage/bdaypreview.php',"_self");
               }
