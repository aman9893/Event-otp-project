    ...
    <div class="container align-center">
        ...
        <div class="team-item col-lg-4 col-md-8">
                <div class="item-image">
                    <a href="invition/index.html"><img src="assets/images/ino2.jpg" alt="" title="" media-simple="true"></a>
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p >

 <a href="invition/index.html">&emsp; Event/Function Theme 1</a>
 <br>
 ...
 <input type="button"  value=' CREATE AND PREVIEW ' onclick="bday_val();"/>
                   ...
                   <div class="item-caption py-3">
                    ...
                    <p >
                     ...
                     <a href="function event/index.html">&emsp; Event/Function Theme 2</a>
                     <br>
                    </div>
                    <br>
