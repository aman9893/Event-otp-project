    ...
    <div class="container align-center">
        ...
        <div class="team-item col-lg-4 col-md-8">
                <div class="item-image">
                    <a href="../theme/invition/index.html"><img src="images/ino2.jpg" alt="" title="" media-simple="true"></a>
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p >

 <a href="../theme/invition/index.html">&emsp; Event/Function Theme 1</a>
 <br>
...
<br/>
 <input type="button" class="btn btn-sm btn-primary display-4"  value=' CREATE AND PREVIEW ' onclick="bday_val();"/>
                   ...
                   <div class="team-item col-lg-4 col-md-8">
                   <div class="item-image">
                    <a href="../theme/invitioncard2/index.html"><img src="images/ino3.jpg" alt="" title="" media-simple="true"></a>
                    </div>
                   <div class="item-caption py-3">
                    <div class="item-name px-2">
                    <p >
                    
                     <a href="../theme/invitioncard2/index.html">&emsp; Event/Function Theme 2</a>
                     <br>
                    </div>
                    <br>
...
function bday_val(){
        ...
        window.open('../formcard/function.php',"_self");
    }
