    ...
    <div class="container align-center">
        ...
        <div class="team-item col-lg-4 col-md-8">
                <div class="item-image">
                    <a href="../theme/weddingtheme1/index.php"><img src="images/merrige-sadibyah.jpg" alt="" title="" media-simple="true"></a>
                </div>
                <div class="item-caption py-3">
                    <div class="item-name px-2">
                        <p >

 <a href="../theme/weddingtheme1/index.php">&emsp; Wedding Theme 1</a>
 <br>
...
<input type="button"  class="btn btn-sm btn-primary display-4"  value=' CREATE AND PREVIEW ' onclick="get_val();"/>
                    ...
                    <div class="team-item col-lg-4 col-md-8">
                    <div class="item-image">
                    <a href="../theme/w2/index.html"><img src="images/marriage3.jpg" alt="" title="" media-simple="true"></a>
                    </div>
                    <div class="item-caption py-3">
                    <div class="item-name px-2">
                    <p >
...
function get_val(){
 ...
 window.open('../formcard/cardform.php',"_self");
